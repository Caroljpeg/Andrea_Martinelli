...
function preload(){
    if (windowWidth < 1000) {
        img1 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_ludotron.png');
        img2 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_lully.png');
        img3 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_malvagio_gaspare.png');
        img4 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_quipre.png');
        img5 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_quipresente.png');
        img6 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_william.png');
        img7 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_chiamatemi_willie.png');
        img8 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_ludoconlebraccia_dark.png');
        img9 = loadImage('media/chiamatemi-quipresente/Mobile_screensaver_ludoconlebraccia.png');
    } else {
        img1 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_ludotron.png');
        img2 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_lully.png');
        img3 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_malvagio_gaspare.png');
        img4 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_quipre.png');
        img5 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_quipresente.png');
        img6 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_william.png');
        img7 = loadImage('media/chiamatemi-quipresente/Screensaver_chiamatemi_willie.png');
        img8 = loadImage('media/chiamatemi-quipresente/Screensaver_ludoconlebraccia.png');
        img9 = loadImage('media/chiamatemi-quipresente/Screensaver_ludoconlebraccia_dark.png');
    }
}
